                    ...
                    while true; do
                        ...
                        case $trace_choice in
                            1)
                                ...
                                echo -e "${yellow} 2. 查核心骨干 (国内段 ASN 雷达字典)：${plain}"
                                echo -e "${yellow}    🟢 普通直连：AS4134(电信163) | AS4837(联通169) | AS9808/AS58453(移动CMI)${plain}"
                                echo -e "${yellow}    👑 尊贵专线：AS4809(电信CN2) | AS9929(联通A网) | AS58807(移动CMIN2)${plain}"
