...
![Platform](https://img.shields.io/badge/Platform-Debian%20%7C%20Ubuntu%20%7C%20CentOS-lightgrey.svg)
...
- **动态状态读取**：一进菜单，直观显示当前防线处于“纯密钥(极安全)”、“混合模式(警告)”还是“纯密码(裸奔)”。
- **双核装甲任选**：支持部署重型装甲 `Fail2Ban`，或极简零消耗的 `纯 Bash 底层机枪塔`，爆破黑客来多少封多少。
...
- **星际舰队群控**：生成 Velox 专属独立兵符（不污染系统密钥），一键向所有僚机群发 Linux 运维指令。

### ⚡ 5. 极限网络底层压榨
- **BBR + fq 黄金组合**：智能识别内核版本，暴力注入拥塞控制算法。
- **TCP/UDP 双管扩容**：针对 Hysteria2 / TUIC 等协议，大幅调优内核读写窗口，配合极客专属的“4K 级 TUI 动态流量视窗”，让网速肉眼可见地起飞。
...
<details>
<summary><b>点击展开查看完整的 27 项全能菜单</b></summary>
